...
test("toString works", () => { 
  ...
  editor.redo(); // ["first"]
  expect(editor.toString()).toEqual("first");
  editor.redo(); // ["first", "second"]
  expect(editor.toString()).toEqual("first second");
  editor.redo(); // ["first", "second", "third"]
  expect(editor.toString()).toEqual("first second third");
  editor.undo(); // ["first", "second"]
  expect(editor.toString()).toEqual("first second");
  editor.undo(); // ["first"]
  expect(editor.toString()).toEqual("first");
